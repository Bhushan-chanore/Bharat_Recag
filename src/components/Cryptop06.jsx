        ...
        <div>
            <section className="relative flex flex-row items-end justify-start sm:gap-[1.188rem] max-w-full text-center text-[3.75rem] text-white font-montserrat ">
                ...
                <div className="z-0 flex-1 flex flex-col items-center justify-end pt-[0rem] px-[0rem] pb-[1.563rem] box-border ">
                    <div className=" flex flex-col items-center justify-center py-[0rem]  sm:px-[1.25rem] px-0 box-border max-w-full">
...
{/* </div> */}
            ...
            <section className=" flex flex-row items-start justify-center sm:gap-[1.188rem] max-w-full text-center text-[3.75rem] text-white font-montserrat sm:mx-[3rem] mx-0">
                ...
                <div className="z-0 py-[4rem] px-0 flex-1 flex flex-col items-start justify-center pt-[6.25rem] pb-[0rem] sm:pr-[1.563rem] pr-[0rem] pl-[0rem] box-border">
                    ...
                    <div className="  flex sm:flex-row flex-col items-start justify-evenly pt-[0rem]  pb-[1.175rem] box-border max-w-full gap-[3.25rem] lg:flex-wrap ">
                        <div className=" flex sm:flex-row flex-col items-start justify-start gap-[1.875rem] lg:flex-1 mq750:flex-wrap mq750:min-w-full" style={{margin:"auto"}} >
                            <div className="relative flex-1 rounded-10xs bg-slateblue flex flex-col items-start justify-start pt-[2rem] pb-[8.875rem] pr-[1.25rem] pl-[2.5rem] box-border gap-[0.313rem] sm:max-w-[350px] sm:w-[350px] max-w-[320] w-[320px] min-h-[232px] hover:bg-white hover:text-slateblue">
                    ...
                    <div className=" flex sm:flex-row flex-col  justify-center pt-[0rem]  pb-[1.175rem] box-border max-w-full gap-[3.25rem] lg:flex-wrap ">
                        <div className=" flex flex-col items-start justify-start pt-[1.181rem] px-[0rem] pb-[0rem] box-border  max-w-full lg:flex-1 mq750:min-w-full">
                            <div className="self-stretch flex sm:flex-row flex-col justify-start gap-[1.875rem] mq750:flex-wrap " style={{margin:"auto"}}>
                                <div className="relative  flex-1 rounded-10xs bg-slateblue flex flex-col items-start justify-start pt-[2rem] pb-[8.875rem] pr-[1.25rem] pl-[2.5rem] box-border gap-[0.313rem] sm:max-w-[350px] sm:w-[350px] max-w-[320] w-[320px] min-h-[232px] hover:bg-white hover:text-slateblue">
                                    <div className="relative tracking-[0.26px] leading-[1.5rem] text-[1rem] font-medium">
                                        <span>{`$10,083.035 `}</span>
                                        <span className="text-tomato">-30.94YTD</span>
...
{/* </div> */}
            ...
            <section className="sm:pl-[5rem] pl-0 flex flex-row items-center justify-start sm:gap-[1.188rem] max-w-full m-auto text-center text-[3.75rem] text-white font-montserrat box-border bg-[url('https://innovio.qodeinteractive.com/wp-content/uploads/2018/10/h4-backround-img-1.png')] bg-cover bg-no-repeat bg-[top] h-[100vh]">
                ...
                <div className="z-0 sm:ml-[5rem] ml-[1rem] flex-1 flex flex-col items-start justify-center pt-0 px-0 pb-[1.563rem] box-border">
...
const Card = ({ data }) => {
    return (
        <div className='mb-[2rem]'>
            <div className="h-[431.5px] sm:w-[300px] w-[290px] flex flex-col items-center justify-center gap-[1.513rem] text-left text-[0.813rem] text-royalblue-100 font-montserrat">
                <img
