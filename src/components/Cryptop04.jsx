...
function Cryptop04() {
  ...
  <div className="w-full max-w-[425.6px] flex flex-col sm:items-center items-center justify-center gap-6">
    <h1 className="text-[2.6rem] font-extrabold leading-[2.5rem] text-white text-center">
      All-in-one gateway
    </h1>
