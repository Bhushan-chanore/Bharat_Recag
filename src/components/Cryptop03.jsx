...
function Cryptop03() {
  ...
  return (
    <div>
      <section className="relative  flex flex-row flex-wrap items-start justify-start sm:gap-[1.188rem] max-w-full text-center sm:text-[3.75rem] text-[3.4rem] text-white font-montserrat overflow-hidden">
                  ...
                  <div className="self-stretch flex flex-col sm:flex-row items-start justify-center gap-[3.094rem] max-w-full text-left text-[0.938rem] text-lightsteelblue mq1050:flex-wrap">
                    ...
                    <div className=" flex  flex-col items-start justify-start pt-[3.444rem] sm:pl-[3.5rem] pl-4 pb-[0rem] box-border">
                      <div className="flex flex-col items-start justify-start gap-[2.063rem]">
                        ...
                        <button className="cursor-pointer ml-[2rem] [border:none] py-[0.675rem]  px-[0.7rem] bg-tomato rounded-3xs overflow-hidden flex flex-row items-end justify-start gap-[0.606rem] z-[2]">
