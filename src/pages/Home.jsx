...
function Home() {
    return (
        <div className='landingpage h-[100vh] bg-darkblue-100 ' style={{backgroundColor:"#2434b3"}}>
            ...
            {/* <div className='h-[100vh] flex flex-col lg:flex-row flex-wrap justify-center items-center'>

<div className='flex flex-col text-white text-[5rem] lg:mr-8 lg:ml-8 p-[5rem] lg:p-0'>
    <h1>Crypto blockchain revolution is here</h1>

    <h3 className="sm:text-[1.2rem] mt-8 leading-[1.625rem] font-medium font-inherit z-[1]  text-white opacity-80">
                        <p className="m-0">
                            Lorem ipsum dolor sit amet, consectetuer adipis cindiam nonummy nibhie euismod tincidunt utlaoreet.</p>
                    </h3>
