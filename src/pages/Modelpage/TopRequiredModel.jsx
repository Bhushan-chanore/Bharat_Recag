    ...
    return (
        <div>
            ...
            <div className="flex sm:my-[1rem] sm:mx-[1.3rem] m-2">
                <Simplemenu />
                <section className={`model das`} style={{ overflow: 'scroll', width: "100vw", backgroundColor: "#ffffff", borderRadius: "15px", padding: "0 2rem", height: "100vh" }}>
                    <div className='sticky top-0 z-50' style={{ padding: "0 2rem", backgroundColor: "#ffffff" }}>
...
export default TopRequiredModel